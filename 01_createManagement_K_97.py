...
cropOptYield = {'sico':6000,'wbar':4000,'wiwh':6000,'cott':6000,'perg':4000 }
cropMaxTDD = {'sico':3000,'wbar':2300,'wiwh':2500,'cott':3000,'perg':6000 }
cropWinterlimit = {'sico':-99.99,'wbar':400,'wiwh':400,'cott':-99.99,'perg':400 }
cropTLimit = {'sico':7,'wbar':7,'wiwh':7,'cott':7,'perg':7 }
...
#DFinputCrops = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="ROT",index_col=0, usecols="B:L", skiprows=1, skipfooter=28 ).fillna('NaN')
DFinputCrops = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="Dates",index_col=0, usecols="A:F", dtype={'Crop':str, 'sico':str, 'wiwh':str, 'perg':str, 'cott':str, 'wbar':str}).fillna('nan')
print DFinputCrops
...
DFinputFertIrri = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="ROT",index_col=0, usecols="B:L", skiprows=1, skipfooter=28 )
#print DFinputFertIrri
#DFinputFertRainfeed = pd.read_csv("GR_thess_fert_rainfeed.csv", sep='\t', index_col=0).fillna('NaN')
DFinputFertRainfeed = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="ROT",index_col=0, usecols="B:L", skiprows=10, skipfooter=19 )
#print DFinputFertRainfeed

#DFinputManureIrri = pd.read_csv("GR_thess_manure_irri.csv", sep='\t', index_col=0).fillna('NaN')
DFinputManureIrri = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="ROT",index_col=0, usecols="B:L", skiprows=20, skipfooter=9 )
#print DFinputManureIrri
#DFinputManureRainfeed = pd.read_csv("GR_thess_manure_rainfeed.csv", sep='\t', index_col=0).fillna('NaN')
DFinputManureRainfeed = pd.read_excel("Management-Input-Data_v3.xlsx",sheet_name="ROT",index_col=0, usecols="B:L", skiprows=29, skipfooter=0 )
